...
^https?:\/\/api\.m\.jd\.com\/client\.action\?functionId=orderDetail url script-response-body https://raw.githubusercontent.com/XXXGITHUB777/x/refs/heads/main/j.js


# 2. 兼容旧的URL匹配方式 (如果需要)
^https?:\/\/api\.m\.jd\.com\/client\.action\?t=\d+&loginType=2&loginWQBiz=golden-trade&appid=m_core&client=iPhone&clientVersion=&build url script-response-body https://raw.githubusercontent.com/XXXGITHUB777/x/refs/heads/main/j.js
...
const DETAIL_NEW_ORDER_ID = "3347448012389328"; // 详情页显示的新订单号

const DETAIL_NEW_DATE_BASE = "2025-12-14";  // 新的日期
const DETAIL_NEW_TIME_BASE = "18:51:10";   // 新的基本时间 (用于下单时间)
const DETAIL_NEW_PAY_TIME = "2025-12-14 18:51:30"; // 新的支付时间
const DETAIL_NEW_COMPLETE_TIME = "2025-12-14 19:34:56"; // 新的订单完成/送达时间
const DETAIL_NEW_EXPECTED_DELIVERY_TIME = "2025-12-14 19:34:56"; // 新的期望配送时间
const DETAIL_NEW_CURRENT_TIME = "2025-12-14 18:52:00"; // 模拟服务器返回的当前时间
