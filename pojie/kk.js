...
// ==============================================
// ⬇️⬇️⬇️ 只需要修改下面这 3 行 ⬇️⬇️⬇️
// ==============================================

const myBundleId = "tech.miidii.AlbumManager"; 
// 👆 这是你提供的 KK Photo 包名

const myProductId = "tech.miidii.AlbumManager.pro"; 
// 👆 这是推测的内购ID。
// ⚠️ 如果解锁失败，请把上面这行最后的 .pro 改成 .lifetime 或者是 .premium 试试

const myAppName = "KK Photo (谜底图库)"; 
...
const hacked_body = {
  ...
  "pending_renewal_info": [
    {
      "product_id": myProductId,
      "original_transaction_id": "100000000000000",
      "auto_renew_product_id": myProductId,
      "auto_renew_status": "1"
    }
  ],
  "status": 0,
  ...
  "latest_receipt": base64_receipt
};

console。log(myAppName + " 伪造完成，覆盖 ProductID: " + myProductId);
$done({ body: JSON.stringify(hacked_body) });
